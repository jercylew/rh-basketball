...
internal class GridRVAdapter(
    ...
    private val mListBalls: List<GridViewModal>,
    private val mObjContext: Context
) :
    BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        if (layoutInflater == null) {
            layoutInflater =
                mObjContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        }
...
//        courseTV = convertView!!.findViewById(R.id.idTVCourse)
        ...
        courseIV.setImageResource(mListBalls[position].courseImg)
